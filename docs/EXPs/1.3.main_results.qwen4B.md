...
````
## test batch size (B=4最好)

````bash
export CUDA_VISIBLE_DEVICES=0
mkdir -p experiments/train/dag_kv_merged_hybrid_training_v2.1_qwen3_4B_aa_B1
nohup python experiments/train.py \
  ...
  --eval_step 200 \
  --total_steps 12000 --N 9999999 \
  --model_save_dir experiments/train/dag_kv_merged_hybrid_training_v2.1_qwen3_4B_aa_B1 \
  --save_period 200 --keep_top_k_ckpt 5 \
  > experiments/train/dag_kv_merged_hybrid_training_v2.1_qwen3_4B_aa_B1/training_log.txt 2>&1 &

export CUDA_VISIBLE_DEVICES=1
mkdir -p experiments/train/dag_kv_merged_hybrid_training_v2.1_qwen3_4B_aa_B2
nohup python experiments/train.py \
  ...
  --eval_step 200 \
  --total_steps 12000 --N 9999999 \
  --model_save_dir experiments/train/dag_kv_merged_hybrid_training_v2.1_qwen3_4B_aa_B2 \
  --save_period 200 --keep_top_k_ckpt 5 \
  > experiments/train/dag_kv_merged_hybrid_training_v2.1_qwen3_4B_aa_B2/training_log.txt 2>&1 &

export CUDA_VISIBLE_DEVICES=3
mkdir -p experiments/train/dag_kv_merged_hybrid_training_v2.1_qwen3_4B_aa_B4
nohup python experiments/train.py \
  --seed 1 --B 4 --lr 5e-4 --use_lr_decay --gradient_accm_step 20 \
  --dataset_type dag \
  --sep_query_head --duplicate_true_kb \
  --dynamic_kb_size 10 50 --outlier_num -999999 \
  --kb_token_layer_frequency 3 \
  ...
  --eval_step 200 \
  --total_steps 12000 --N 9999999 \
  --model_save_dir experiments/train/dag_kv_merged_hybrid_training_v2.1_qwen3_4B_aa_B4 \
  --save_period 200 --keep_top_k_ckpt 5 \
  > experiments/train/dag_kv_merged_hybrid_training_v2.1_qwen3_4B_aa_B4/training_log.txt 2>&1 &
...
python3 /mnt/n0/PathWeaver/experiments/eval_generation.py generation \
  ...
  --model_dir /mnt/n0/PathWeaver/experiments/train/dag_kv_merged_hybrid_training_v2.1_qwen3_14B_aa_B2/stage1_lr_0.0005KBTokenLayerFreq3UseOutlier-999999KBSizedynamicSepQueryHeadKeyFromkey_qwen-embedding-0.6B_dag_qwen3_step_7999 \
  --encoder_dir /mnt/n0/PathWeaver/experiments/train/dag_kv_merged_hybrid_training_v2.1_qwen3_14B_aa_B2/stage1_lr_0.0005KBTokenLayerFreq3UseOutlier-999999KBSizedynamicSepQueryHeadKeyFromkey_qwen-embedding-0.6B_dag_qwen3_step_7999_encoder/encoder.pt \
...
python3 /mnt/n0/PathWeaver/experiments/eval_generation.py generation \
  ...
  --t_step 8000 \
  --kb_scale_factor 4 --path_attn_mix_ratio 0.8
' > /mnt/n0/PathWeaver/docs/EXPs/main_results_qwen314B_dag_kv_aa.log 2>&1 &
````